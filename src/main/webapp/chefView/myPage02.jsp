        ...
        <div id="news_cast"><!-- news_cast -->
            <div class="area_newstop"><!-- area_newstop -->
            		<div class="chef_search">
						<input type="text" id="user_search" class="user_search"  style="width: 41%;
																					    height: 35px;
																					    display: block;
																					    float: left;
																					    margin-left: 30%;
						...
						<button type="submit" onclick="doSearch()" class="doSearch_btn" style="float: left; 
																								margin-top: 20px;
																								width: 39px;
    																							height: 39px;">
							<img src="pngwing.png">
            		...
            		<li>
            			<a href="#" class="model">
            				...
            				<div class="recipe_subject">
            					<h3 style="font-size: 15px; font-weight: bold;">레시피 명 1</h3>
